    ...
    <div class="game-lore" id="game-lore">
      ...
      <details class="game-lore-block">
        ...
        <ul class="game-lore-list">
          ...
          <li>单周领取过<strong>全部</strong>条目会计入终身「清满周」次数（通鉴与数据总览可见）；累计 <strong>1 / 12 / 24</strong> 次清满周等可在<strong>成就</strong>领奖。</li>
      ...
      <details class="game-lore-block">
        ...
        <ul class="game-lore-list">
          ...
          <li><strong>唤灵</strong>：每次消耗 <strong>42</strong> 唤灵髓邂逅一只灵宠；稀有度按池内权重随机。累计唤引达 <strong>25 / 100 / 300</strong> 次可在<strong>成就</strong>领奖。</li>
