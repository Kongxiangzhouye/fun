...
import {
  ...
  UI_CHRONICLE_IDLE_LING_SHA_DRIP_STAT,
  ...
  return `
    <section class="panel chronicle-panel">
      ...
      <div class="chronicle-stats-grid">
        ...
        <div class="chronicle-stat-card chronicle-stat-card--idle-ling-sha-drip">
          <img class="chronicle-stat-ico" src="${UI_CHRONICLE_IDLE_LING_SHA_DRIP_STAT}" alt="" width="32" height="32" loading="lazy" />
          <div>
            <span class="chronicle-stat-lbl">灵砂涓滴收取</span>
            <strong class="chronicle-stat-val">${ls.idleLingShaDripClaims} 次</strong>
          </div>
        </div>
        ...
        <div class="chronicle-stat-card chronicle-stat-card--dao-spend">
          <img class="chronicle-stat-ico" src="${UI_CHRONICLE_DAO_ESSENCE_SPENT_STAT}" alt="" width="32" height="32" loading="lazy" />
          <div>
            <span class="chronicle-stat-lbl">累计消耗道韵</span>
            <strong class="chronicle-stat-val">${ls.daoEssenceSpentLifetime}</strong>
          </div>
        </div>
        <div class="chronicle-stat-card chronicle-stat-card--summon-spend">
          <img class="chronicle-stat-ico" src="${UI_CHRONICLE_SUMMON_ESSENCE_SPENT_STAT}" alt="" width="32" height="32" loading="lazy" />
          <div>
        ...
        <div class="chronicle-stat-card chronicle-stat-card--ling-spend">
          <img class="chronicle-stat-ico" src="${UI_CHRONICLE_LING_SHA_SPENT_STAT}" alt="" width="32" height="32" loading="lazy" />
          <div>
            <span class="chronicle-stat-lbl">累计消耗灵砂</span>
            <strong class="chronicle-stat-val">${ls.lingShaSpentLifetime}</strong>
          </div>
        </div>
        <div class="chronicle-stat-card chronicle-stat-card--xuan-spend">
          <img class="chronicle-stat-ico" src="${UI_CHRONICLE_XUAN_TIE_SPENT_STAT}" alt="" width="32" height="32" loading="lazy" />
          <div>
